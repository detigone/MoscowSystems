            ...
            return (
                await ctx.reply(
                    embed=discord.Embed(
                        ...
                        description="A user has inputted an arbitrary time amount of time into CycleRM and we were unable to display the requested data because of this. Please find the source of this, and remove the excess amount of time.",
                        color=BLANK_COLOR,
                    )
                )
                if not do_not_send
