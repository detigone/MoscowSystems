...
class Search(commands.Cog):
    ...
    @commands.hybrid_command(
        ...
        description="Lookup your punishments with CycleRM.",
    ...
    async def mywarnings(
        ...
        if self.bot.punishments_disabled is True:
            return await failure_embed(
                ctx,
                "This command is currently disabled as CycleRM is currently undergoing maintenance updates. This command will be turned off briefly to ensure that no data is lost during the maintenance. It will be returned shortly.",
            )
        ...
        magic_flags = {
            "CycleRM Team": 1001972346661384302,
            "CycleRM Developer": 1046204873496068176,
            "CycleRM Management": 1038597868023447552,
            "CycleRM Senior Support": 1028848687927013396,
            "CycleRM Support": 1053417531278364713,
            "CycleRM Staff": 988055417907200010,
            "CycleRM Quality Assurance": 1306431506914218067,
        }
        ...
        if member and bot.environment != "CUSTOM":
            ...
            applied_flags.update(["CycleRM Staff"])
