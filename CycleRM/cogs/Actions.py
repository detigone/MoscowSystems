...
class Actions(commands.Cog):
    ...
    @commands.hybrid_group(
        name="actions", description="Manage your CycleRM Actions easily."
    )
    async def actions(self, ctx: commands.Context):
        pass

    @actions.command(name="manage", description="Manage your CycleRM Actions easily.")
    @is_admin()
    ...
    @actions.command(name="execute", description="Execute an CycleRM Action in your server")
    @is_staff()
