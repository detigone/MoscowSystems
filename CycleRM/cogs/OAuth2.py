...
class OAuth2(commands.Cog):
    ...
    @commands.hybrid_command(
        name="link",
        description="Link your Roblox account with CycleRM.",
    ...
    async def link_roblox(self, ctx: commands.Context):
        ...
        verification_message = {
            "embed": discord.Embed(
                title="Verify with CycleRM",
                description="**To link your account with CycleRM, click the button below.**\nIf you encounter an error, please contact CycleRM Support by running `/support`.",
                color=BLANK_COLOR,
            ),
                ...
                if await self.bot.oauth2_users.db.find_one(
                    ...
                    await msg.edit(
                        embed=discord.Embed(
                            ...
                            description="Your Roblox account has been successfully linked to CycleRM.",
                            color=GREEN_COLOR,
                        )
                    )
                    break
