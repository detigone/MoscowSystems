    ...
    async def punish(self, ctx, user: str, type: str, *, reason: str):
        ...
        if self.bot.punishments_disabled is True:
            return await new_failure_embed(
                ctx,
                "Maintenance",
                "This command is currently disabled as CycleRM is currently undergoing maintenance updates. This command will be turned off briefly to ensure that no data is lost during the maintenance.",
            )
