...
class ERLC(commands.Cog):
    ...
    @mc.command(name="link", description="Link your Maple County server with CycleRM!")
    @is_management()
        ...
        try:
            ...
            return await ctx.send(
                embed=discord.Embed(
                    ...
                    description="We could not find a server you own under the server name provided. Make sure you are linked with CycleRM by running `/link` in any server.",
                    color=BLANK_COLOR,
                )
            )
    ...
    @server.command(
        name="message", description="Send a Message to your ER:LC server with CycleRM!"
    )
    @is_staff()
    @is_server_linked()
    ...
    @server.command(
        name="hint", description="Send a Hint to your ER:LC server with CycleRM!"
    )
    @is_staff()
    @is_server_linked()
    ...
    @server.command(
        name="link",
        description="Link your ER:LC server with CycleRM!",
    ...
    @server.command(
        name="unlink",
        description="Unlink your ER:LC server from CycleRM!",
    )
    @is_management()
    @is_server_linked()
    async def server_unlink(self, ctx: commands.Context):
        ...
        await ctx.send(
            embed=discord.Embed(
                ...
                description="I have unlinked your ER:LC server from CycleRM.",
                color=GREEN_COLOR,
            )
        )
